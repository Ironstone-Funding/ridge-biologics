...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    name: "EmCyte Sapphire Centrifuge",
    tagline: "The all-in-one processing platform for PRP, BMC, and adipose concentrate.",
    category: "PRP",
    categoryColor: "#1a6b8a",
    ...
    companyUrl: "https://www.emcyte.com",
    image: "/images/products/emcyte-prp.webp",
    description: "EmCyte's portable touchscreen centrifuge — the required processing unit for PurePRP® SP and PureBMC® SP kits.",
    overview:
      "The Sapphire Centrifuge is EmCyte's all-in-one point-of-care processing platform. Weighing just 31 lbs, it is fully portable and processes PRP, bone marrow concentrate (BMC), and adipose concentrate from a single device. Pre-programmed touchscreen protocols paired with open customization settings give clinicians full control over processing parameters. The Sapphire is the required centrifuge for running PurePRP® SP and PureBMC® SP kits.",
    features: [
      "Processes PRP, BMC, and adipose concentrate",
      "31-lb portable design — moves room to room with ease",
      "Touchscreen interface with pre-set program protocols",
      "Open settings for customized processing parameters",
      "Required for use with PurePRP® SP and PureBMC® SP kits",
      "Consistent, reproducible results across procedures",
    ],
    indications: "Capital equipment for point-of-care preparation of autologous biologics. For use with EmCyte PurePRP® SP and PureBMC® SP single-use processing kits. For use by licensed healthcare providers only.",
    mechanismOfAction:
      "The Sapphire Centrifuge provides the centrifugal force and programmable spin profiles required to process autologous blood and bone marrow aspirate through EmCyte's closed-system kits. All clinical protocols and applications are determined by the treating physician. Ridge Biologics does not make claims regarding clinical outcomes or comparative effectiveness.",
    comingSoon: false,
  },
  {
    id: "emcyte-bmc",
